...
let henrietta = new Traveler('Henrietta', 'Cleric')
let juan = new Traveler('Juan', 'Fighter')
...
juan.hunt()
console.log('Juan went hunting and caught a boar!')
henrietta.heal(juan)
console.log('Henrietta heals Juan')
console.log(juan)
